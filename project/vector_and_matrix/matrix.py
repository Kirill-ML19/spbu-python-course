...
def matrix_addition(
    mat1: List[List[Union[float, int]]], mat2: List[List[Union[float, int]]]
...
def matrix_multiplication(
    ...
    result: List[List[Union[float,int]]]=[[0 for _ in range(len(mat2[0]))] for _ in range(len(mat1))]
